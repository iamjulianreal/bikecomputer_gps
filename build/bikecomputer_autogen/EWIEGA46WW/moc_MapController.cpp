...
QT_MOC_LITERAL(1, 14, 7), // "setView"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 10), // "mapViewObj"
QT_MOC_LITERAL(4, 34, 3), // "lat"
QT_MOC_LITERAL(5, 38, 3), // "lon"
QT_MOC_LITERAL(6, 42, 4) // "zoom"

    },
    "MapController\0setView\0\0mapViewObj\0lat\0"
    "lon\0zoom"
};
...
static const uint qt_meta_data_MapController[] = {
 ...
 // methods: parameters
    QMetaType::Void, QMetaType::QObjectStar, QMetaType::Double, QMetaType::Double, QMetaType::Double,    3,    4,    5,    6,
...
void MapController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->setView((*reinterpret_cast< QObject*(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4]))); break;
        default: ;
        }
    }
}
